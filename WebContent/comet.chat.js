(function($){
	$.cometChat = {
        ...
        members:function(message) {
         ...
         sb[sb.length] = "<span  style=\";color: #808080; padding:5px;\">" + this + "</span><br>";
            	} else { //peer users
            		sb[sb.length] = "<span  onclick=\"javascript:createWindow('" + $.cometChat.loginUserName + "', '" + this + "');\"  style=\"cursor: pointer; padding:5px ;color: #0000FF;\">" + this + "</span><br>";
            	}
            });
